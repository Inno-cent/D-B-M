...
export const products: Product[] = [
  ...
  // },
  {
    ...
    description:
      "Split and dried Nigerian ginger with high gingerol content, sourced from Kaduna and Nasarawa. One of Nigeria's top export commodities with strong demand in Asia and Europe.",
    specs: [
  ...
  },
  {
    ...
    description:
      'High-quality raw cashew nuts and processed cashew kernels sourced from farms in Oyo, Kwara, and Kogi. Graded to W180, W240, W320 specifications for export.',
    specs: [
  ...
  },
  {
    ...
    description:
      'Premium quality shea butter extracted from shea nuts harvested across Northern Nigeria. Available in both crude and refined forms for cosmetics, food, and pharmaceutical applications.',
    specs: [
  ...
  },
  {
    ...
    description:
      'Shelled and unshelled groundnuts sourced from the northern groundnut belt of Nigeria. Rich in oil content and protein, suitable for oil pressing, confectionery, and food processing.',
    specs: [
  ...
  },
  {
    ...
    description:
      'Nigerian cocoa is regarded among the finest in West Africa. Sourced from farms in Ondo, Cross River, and Osun states, fermented and dried to international Grade 1 standards.',
    specs: [
  ...
  },
  {
    ...
    description:
      'Non-GMO soyabeans grown in Benue, Kwara, and Kogi states. Used for soyabean oil extraction, animal feed production, and food processing. High protein content suitable for export.',
    specs: [
