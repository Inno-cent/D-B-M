...
export const products: Product[] = [
  ...
  },
  {
    ...
    slug: 'thyme',
    icon: '🌿',
    image: getProductImageUrl('ChatGPT Image Sep 15, 2026, 07_27_24 PM', 'png'),
    type: 'local',
    categories: ['spices-seasonings'],
    family: 'thyme',
    ...
    variants: [
      ...
      },
      {
        ...
        size: 'Sachet',
        image: getProductImageUrl('ChatGPT Image Sep 16, 2026, 06_42_38 PM', 'png'),
      },
      {
        // No new image — keeps existing photo.
  ...
  },
  {
    ...
    variants: [
      ...
      //   size: '240g',
      //   image: getProductImageUrl('ChatGPT Image Sep 15, 2026, 11_39_18 AM', 'png'),
      // },
      {
        // NEW VARIANT
  ...
  },
  {
    ...
    icon: '🧂',
    image: getProductImageUrl('ChatGPT Image Sep 16, 2026, 06_42_47 PM', 'png'),
    type: 'local',
    categories: ['spices-seasonings'],
    detail: '400g',
