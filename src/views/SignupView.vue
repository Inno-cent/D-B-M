<template>
  <div class="min-h-screen bg-cream flex">
    ...
    <div class="flex-1 flex items-center justify-center px-6 py-20 overflow-y-auto">
      <div class="w-full max-w-md">
        ...
        <RouterLink to="/" class="flex items-center gap-3 mb-10 group w-fit">
          ...
          <div>
            <span class="font-bold text-earth-900 block leading-none text-base">DualMarket</span>
        ...
        <Transition name="fade-slide">
          <div v-if="success"
            ...
            <div class="flex items-center gap-3 mb-2">
              <div class="w-8 h-8 bg-forest-600 rounded-lg flex items-center justify-center flex-shrink-0">
        ...
        <form v-if="!success" @submit.prevent="handleSignup" class="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              class="input-field"
              :class="form.confirmPassword && form.password !== form.confirmPassword
    ...
    <div class="hidden lg:flex flex-1 relative overflow-hidden max-w-xl">
      ...
      />
      <div class="absolute inset-0 bg-gradient-to-br from-forest-900/82 to-forest-800/55" />
        ...
        <div class="space-y-6">
          ...
          <div class="space-y-3">
            <div v-for="point in benefits" :key="point" class="flex items-center gap-3">
              <div class="w-5 h-5 bg-green-500/20 border border-green-400/40 rounded-lg
