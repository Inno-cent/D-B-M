<template>
  <div class="min-h-screen bg-cream flex items-center justify-center px-6 py-20">
    <div class="w-full max-w-md">
      ...
      <RouterLink
        to="/login"
        class="inline-flex items-center gap-2 text-sm text-earth-500 hover:text-forest-600 transition-colors mb-8"
      >
        ← Back to Sign In
      </RouterLink>
        ...
        <Transition name="fade-slide" mode="out-in">
          ...
          <div v-if="!sent" key="form">
            ...
            <p class="text-earth-500 text-sm leading-relaxed mb-6">
              Enter the email linked to your account and we will send a reset link to your
              inbox.
            </p>
